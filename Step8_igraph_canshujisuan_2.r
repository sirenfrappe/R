...
write_csv(D0_D1,"./output/igraph_canshujisuan_2/D0_D1.csv")
###############################################################
...
write_csv(D0_N0,"./output/igraph_canshujisuan_2/D0_N0.csv")
###############################################################
...
write_csv(D0_N1,"./output/igraph_canshujisuan_2/D0_N1.csv")
###############################################################
...
write_csv(D1_N0,"./output/igraph_canshujisuan_2/D1_N0.csv")
###############################################################
...
write_csv(D1_N1,"./output/igraph_canshujisuan_2/D1_N1.csv")
###############################################################
...
write_csv(N0_N1,"./output/igraph_canshujisuan_2/N0_N1.csv")
#################################################################
...
ggplot(data_PTM_draw,aes(x=classification,y=transitivity))+
  ...
  ggsave("./output/igraph_canshujisuan_2/transitivity.tiff")
##drgree
ggplot(data_PTM_draw,aes(x=classification,y=degree))+
  ...
  ggsave("./output/igraph_canshujisuan_2/degree.tiff")
##closeness
ggplot(data_PTM_draw,aes(x=classification,y=closeness))+
  ...
  ggsave("./output/igraph_canshujisuan_2/closeness.tiff")
##eigen_centrality
ggplot(data_PTM_draw,aes(x=classification,y=eigen_centrality))+
  ...
  ggsave("./output/igraph_canshujisuan_2/eigen_centrality.tiff")
##betweenness
ggplot(data_PTM_draw,aes(x=classification,y=betweenness))+
  ...
  ggsave("./output/igraph_canshujisuan_2/betweenness.tiff")
##page_rank
ggplot(data_PTM_draw,aes(x=classification,y=page_rank))+
  ...
  ggsave("./output/igraph_canshujisuan_2/page_rank.tiff")
